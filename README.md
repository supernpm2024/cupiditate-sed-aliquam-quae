...
![Language Details](https://img.shields.io/github/languages/top/bennycode/@supernpm2024/cupiditate-sed-aliquam-quae) ![Code Coverage](https://img.shields.io/codecov/c/github/bennycode/@supernpm2024/cupiditate-sed-aliquam-quae/main) ![License](https://img.shields.io/npm/l/@supernpm2024/cupiditate-sed-aliquam-quae.svg) ![Package Version](https://img.shields.io/npm/v/@supernpm2024/cupiditate-sed-aliquam-quae.svg)

Technical indicators and overlays to run technical analysis with JavaScript / TypeScript.

## Motivation

The "@supernpm2024/cupiditate-sed-aliquam-quae" library provides a TypeScript implementation for common technical indicators with arbitrary-precision decimal arithmetic.
...
```typescript
import {Big, SMA} from '@supernpm2024/cupiditate-sed-aliquam-quae';
...
```ts
import {SMA} from '@supernpm2024/cupiditate-sed-aliquam-quae';
...
As specified by the ECMAScript standard, all arithmetic in JavaScript uses [double-precision floating-point arithmetic](https://en.wikipedia.org/wiki/Double-precision_floating-point_format), which is only accurate until certain extent. To increase the accuracy and avoid miscalculations, the [@supernpm2024/cupiditate-sed-aliquam-quae](https://github.com/supernpm2024/cupiditate-sed-aliquam-quae) library uses [big.js][1] which offers arbitrary-precision decimal arithmetic. However, this arbitrary accuracy comes with a downside: Calculations with it are not as performant as with the primitive data type `number`.
...
```ts
import {FasterStochasticRSI, FasterSMA} from '@supernpm2024/cupiditate-sed-aliquam-quae';
...
The information and publications of [@supernpm2024/cupiditate-sed-aliquam-quae](https://github.com/supernpm2024/cupiditate-sed-aliquam-quae) do not constitute financial advice, investment advice, trading advice or any other form of advice. All results from [@supernpm2024/cupiditate-sed-aliquam-quae](https://github.com/supernpm2024/cupiditate-sed-aliquam-quae) are intended for information purposes only.
...
[<img src="https://raw.githubusercontent.com/bennycode/@supernpm2024/cupiditate-sed-aliquam-quae/main/tstv.png">](https://typescript.tv/)
